                     ...
                     <div key={field.id} className="p-2 border rounded-lg space-y-2 relative">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel htmlFor={field.name}>Person-in-Charge</FormLabel>
                                        <FormControl>
                                            <Input id={field.name} placeholder="e.g., A. Exparas, HR" {...field} value={field.value ?? ''} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        >
                                            <FormControl>
                                                <SelectTrigger id={field.name}><SelectValue placeholder="Select status..." /></SelectTrigger>
                                            </FormControl>
                                            <SelectContent>
